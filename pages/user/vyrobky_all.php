...
<?php if( !$products){ ?>
	<div class="row">
		<div class="col-sm-12">
			<h3 class="text-danger">Táto spoločnosť zatiaľ nemá žiadne materiály</h3>
		</div>
	</div>
<?php }else{ ?>
	<div class="row">
		<div class="col-sm-12">
			<h1>Všetky materiály spoločnosti</h1>
		</div>
		<div class="col-sm-12">
...
<div class="row">
	<div class="col-sm-12">
		...
		if( have_permission($user_profile['id'],5) ){?>
			<a href="/user/product_edit?id=0" class="btn btn-success">Vytvoriť nový materiál</a>
		<?php } ?>
		<?php if($products){?>
